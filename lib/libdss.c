...
for (i0 = 0; i0 < 1024; i0++) {
if (p->freq_misc[i0].time == 0) break;
printf("log.append({ 'type' : 'freq_misc', 'time' : %lld.%09lld, 'cpu' : %d, 'freq_type' : %d, 'freq_name' : '%p', 'old_freq' : %lu, 'target_freq' : %lu, 'en' : %d, })\n",
p->freq_misc[i0].time/1000000000LL,p->freq_misc[i0].time%1000000000LL,
p->freq_misc[i0].cpu,
p->freq_misc[i0].freq_type,
p->freq_misc[i0].freq_name,
p->freq_misc[i0].old_freq,
p->freq_misc[i0].target_freq,
p->freq_misc[i0].en);
}
for (i0 = 0; i0 < 1024; i0++) {
